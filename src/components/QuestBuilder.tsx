    ...
    <div className="max-w-6xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-6">
          Choose from our AI-generated suggestions or create your own tasks. These will become your daily quests for personal growth.
        </p>
        
        {selectedTasks.length > 0 && (
          <div className="inline-flex items-center bg-green-100 text-green-700 px-4 py-2 rounded-full">
            <Check className="w-4 h-4 mr-2" />
            <span className="font-medium">{selectedTasks.length} quest{selectedTasks.length !== 1 ? 's' : ''} selected</span>
          </div>
        )}
      </div>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600 mb-2">
            {selectedTasks.length === 0 ? 'Select some quests to continue' : 
             `${selectedTasks.length} quest${selectedTasks.length !== 1 ? 's' : ''} ready to start`}
          </p>
        </div>
