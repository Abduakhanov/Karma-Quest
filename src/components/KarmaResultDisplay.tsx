    ...
    <div className="max-w-6xl mx-auto">
      <div className="text-center mb-8">
        <div className="inline-flex items-center bg-gradient-to-r from-purple-100 to-teal-100 rounded-full px-4 py-2 mb-4">
          ...
          <span className="text-sm font-medium text-purple-700">Your karma has been determined!</span>
        </div>
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Based on your responses, we've identified your unique karmic path
        </p>
      </div>
      ...
      <div className="bg-gradient-to-r from-purple-600 to-teal-600 rounded-xl p-8 text-white mb-8">
        <div className="text-center">
          ...
          <h3 className="text-2xl font-bold mb-2">Your primary karma:</h3>
          ...
          <div className="bg-white/10 rounded-lg p-4 inline-block">
            <div className="text-sm text-purple-100 mb-1">Confidence in result</div>
      ...
      {result.secondaryKarma && SecondaryIcon && (
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              <h4 className="text-lg font-semibold text-gray-900">Secondary karma:</h4>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <h3 className="text-xl font-semibold text-gray-900 mb-6">Your spiritual path</h3>
        ...
        {/* Element & Chakra */}
        <div className="bg-white rounded-xl shadow-lg p-6">
          <h3 className="text-xl font-semibold text-gray-900 mb-6">Energy profile</h3>
          ...
          <div className="space-y-6">
            ...
            <div>
              <h4 className="font-medium text-gray-900 mb-2">Primary chakra</h4>
              <p className="text-gray-700">{result.primaryKarma.chakra}</p>
            </div>
            
            <div>
              <h4 className="font-medium text-gray-900 mb-2">Compatible karma types</h4>
      ...
      {/* Recommendations */}
      <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
        <h3 className="text-xl font-semibold text-gray-900 mb-6">Development recommendations</h3>
      ...
      {Object.keys(result.beliefSystemInsights).length > 0 && (
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <h3 className="text-xl font-semibold text-gray-900 mb-6">Belief system insights</h3>
          <div className="space-y-6">
