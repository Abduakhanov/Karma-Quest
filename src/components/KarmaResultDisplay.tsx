    ...
    <div className="max-w-6xl mx-auto">
      <div className="text-center mb-8">
        <div className="inline-flex items-center bg-gradient-to-r from-purple-100 to-teal-100 rounded-full px-4 py-2 mb-4">
          ...
          <span className="text-sm font-medium text-purple-700">{t('insight.karmaReady')}</span>
        </div>
      ...
      {result.secondaryKarma && SecondaryIcon && (
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              <h4 className="text-lg font-semibold text-gray-900">{t('insight.secondaryKarma')}:</h4>
              <p className="text-purple-600 font-medium">{t(`common:karma.types.${result.secondaryKarma.id}`)}</p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <h3 className="text-xl font-semibold text-gray-900 mb-6">{t('insight.spiritualPath')}</h3>
          
          <div className="space-y-6">
            <div>
              <h4 className="font-medium text-gray-900 mb-2 flex items-center">
                <BookOpen className="w-5 h-5 mr-2 text-purple-600" />
                {t('insight.lifeLesson')}
              </h4>
        ...
        {/* Element & Chakra */}
        <div className="bg-white rounded-xl shadow-lg p-6">
          <h3 className="text-xl font-semibold text-gray-900 mb-6">{t('insight.energyProfile')}</h3>
          
          <div className="space-y-6">
            <div>
              <h4 className="font-medium text-gray-900 mb-2">{t('insight.element')}</h4>
            ...
            <div>
              <h4 className="font-medium text-gray-900 mb-2">{t('insight.primaryChakra')}</h4>
              <p className="text-gray-700">{result.primaryKarma.chakra}</p>
            </div>
            
            <div>
              <h4 className="font-medium text-gray-900 mb-2">{t('insight.compatibleTypes')}</h4>
      ...
      {/* Recommendations */}
      <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
        <h3 className="text-xl font-semibold text-gray-900 mb-6">{t('insight.recommendations')}</h3>
      ...
      {Object.keys(result.beliefSystemInsights).length > 0 && (
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <h3 className="text-xl font-semibold text-gray-900 mb-6">{t('insight.beliefInsights')}</h3>
          <div className="space-y-6">
